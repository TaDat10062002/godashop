...
<main id="maincontent" class="page-main">
    <div class="container">
        <div class="row">
            ...
            <?php require 'view/customer/sidebarAccount.php' ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form class="info-account" action="?c=customer&a=updateAccount" method="POST" role="form">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" name="password_confirmation" placeholder="Nhập lại mật khẩu mới" autocomplete="off" autosave="off">
                            </div>
                            <div class="form-group">
